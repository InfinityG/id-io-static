  ...
  module DefaultRoutes
    def self.registered(app)
      app.get '/' do
        ...
        File.new('www/index.html').readlines
      end

      app.get '/css/:resource' do
        content_type 'text/css'
        File.new("www/css/#{params[:resource]}").readlines
      end

      app.get '/fonts/:resource' do
        content_type 'application/x-font-ttf'
        File.new("www/fonts/#{params[:resource]}").readlines
      end
      ...
      app.get '/images/:resource' do
        ...
        File.new("www/images/#{params[:resource]}").readlines
      end

      app.get '/js/:resource' do
        content_type 'application/javascript'
        File.new("www/js/#{params[:resource]}").readlines
      end
    end
  end
end